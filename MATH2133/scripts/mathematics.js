/*
    ...
    https://mathematicseducation.appspot.com/MATH2133/GradesCalculator.html
*/
...
function gradeMLM(event) {
    ...
    var weightElevenOne1st = parseFloat(document.getElementById("weightElevenOne1st").value, 10) || 0,
        ...
        weightElevenThree1st = parseFloat(document.getElementById("weightElevenThree1st").value, 10) || 0,
        scoreElevenThree1st = parseFloat(document.getElementById("scoreElevenThree1st").value, 10) || 0,
        weightedScoreElevenThree1st,

        weightElevenThree2nd =+ parseFloat(document.getElementById("weightElevenThree2nd").value, 10) || 0,
        scoreElevenThree2nd =+ parseFloat(document.getElementById("scoreElevenThree2nd").value, 10) || 0,
        ...
        weightThirteenTwo1st = parseFloat(document.getElementById("weightThirteenTwo1st").value, 10) || 0,
        scoreThirteenTwo1st = parseFloat(document.getElementById("scoreThirteenTwo1st").value, 10) || 0,
        weightedScoreThirteenTwo1st,

        weightThirteenTwo2nd =+ parseFloat(document.getElementById("weightThirteenTwo2nd").value, 10) || 0,
        scoreThirteenTwo2nd =+ parseFloat(document.getElementById("scoreThirteenTwo2nd").value, 10) || 0,
        weightedScoreThirteenTwo2nd,

        weightThirteenTwo3rd =+ parseFloat(document.getElementById("weightThirteenTwo3rd").value, 10) || 0,
        scoreThirteenTwo3rd =+ parseFloat(document.getElementById("scoreThirteenTwo3rd").value, 10) || 0,
        ...
        weightThirteenThree3rd =+ parseFloat(document.getElementById("weightThirteenThree3rd").value, 10) || 0,
        scoreThirteenThree3rd =+ parseFloat(document.getElementById("scoreThirteenThree3rd").value, 10) || 0,
        weightedScoreThirteenThree3rd,

        weightThirteenFour1st = parseFloat(document.getElementById("weightThirteenFour1st").value, 10) || 0,
        scoreThirteenFour1st = parseFloat(document.getElementById("scoreThirteenFour1st").value, 10) || 0,
        weightedScoreThirteenFour1st,

        weightThirteenFour2nd =+ parseFloat(document.getElementById("weightThirteenFour2nd").value, 10) || 0,
        scoreThirteenFour2nd =+ parseFloat(document.getElementById("scoreThirteenFour2nd").value, 10) || 0,
        weightedScoreThirteenFour2nd,

        weightThirteenFive1st = parseFloat(document.getElementById("weightThirteenFive1st").value, 10) || 0,
        scoreThirteenFive1st = parseFloat(document.getElementById("scoreThirteenFive1st").value, 10) || 0,
        weightedScoreThirteenFive1st,

        weightThirteenFive2nd =+ parseFloat(document.getElementById("weightThirteenFive2nd").value, 10) || 0,
        scoreThirteenFive2nd =+ parseFloat(document.getElementById("scoreThirteenFive2nd").value, 10) || 0,
        ...
        weightEightThree2nd =+ parseFloat(document.getElementById("weightEightThree2nd").value, 10) || 0,
        ...
        weightTwelveFour2nd =+ parseFloat(document.getElementById("weightTwelveFour2nd").value, 10) || 0,
        ...
        sumWeightsMLM = 
        weightElevenOne1st + weightElevenOne2nd 
        + weightElevenTwo1st + weightElevenTwo2nd 
        + weightElevenThree1st + weightElevenThree2nd 
        + weightElevenFour1st + weightElevenFour2nd 
        + weightThirteenOne1st + weightThirteenOne2nd 
        + weightThirteenTwo1st + weightThirteenTwo2nd + weightThirteenTwo3rd
        + weightThirteenThree1st + weightThirteenThree2nd + weightThirteenThree3rd
        + weightThirteenFour1st + weightThirteenFour2nd 
        + weightThirteenFive1st + weightThirteenFive2nd 
        + weightEightOne1st + weightEightOne2nd 
        + weightEightTwo 
        + weightEightThree1st + weightEightThree2nd 
        + weightEightFour1st + weightEightFour2nd 
        + weightTenOne1st + weightTenOne2nd 
        + weightTenTwo1st + weightTenTwo2nd 
        + weightTenThree
        + weightTenFour1st + weightTenFour2nd + weightTenFour3rd
        + weightNineOne1st + weightNineOne2nd 
        + weightNineTwo1st + weightNineTwo2nd 
        + weightNineThree1st + weightNineThree2nd 
        + weightNineFour1st + weightNineFour2nd
        + weightTwelveOne1st + weightTwelveOne2nd 
        + weightTwelveTwo1st + weightTwelveTwo2nd 
        + weightTwelveThree
        + weightTwelveFour1st + weightTwelveFour2nd 
        ;

        document.getElementById("sumWeightsMLM").value = sumWeightsMLM;
        
        sumWeightedScoresMLM = 
        weightedScoreElevenOne1st + weightedScoreElevenOne2nd 
        + weightedScoreElevenTwo1st + weightedScoreElevenTwo2nd 
        + weightedScoreElevenThree1st + weightedScoreElevenThree2nd 
        + weightedScoreElevenFour1st + weightedScoreElevenFour2nd 
        + weightedScoreThirteenOne1st + weightedScoreThirteenOne2nd 
        + weightedScoreThirteenTwo1st + weightedScoreThirteenTwo2nd + weightedScoreThirteenTwo3rd
        + weightedScoreThirteenThree1st + weightedScoreThirteenThree2nd + weightedScoreThirteenThree3rd
        + weightedScoreThirteenFour1st + weightedScoreThirteenFour2nd 
        + weightedScoreThirteenFive1st + weightedScoreThirteenFive2nd 
        + weightedScoreEightOne1st + weightedScoreEightOne2nd
        + weightedScoreEightTwo
        + weightedScoreEightThree1st + weightedScoreEightThree2nd 
        + weightedScoreEightFour1st + weightedScoreEightFour2nd 
        + weightedScoreTenOne1st + weightedScoreTenOne2nd 
        + weightedScoreTenTwo1st + weightedScoreTenTwo2nd 
        + weightedScoreTenThree
        + weightedScoreTenFour1st + weightedScoreTenFour2nd + weightedScoreTenFour3rd
        + weightedScoreNineOne1st + weightedScoreNineOne2nd 
        + weightedScoreNineTwo1st + weightedScoreNineTwo2nd 
        + weightedScoreNineThree1st + weightedScoreNineThree2nd 
        + weightedScoreNineFour1st + weightedScoreNineFour2nd
        + weightedScoreTwelveOne1st + weightedScoreTwelveOne2nd 
        + weightedScoreTwelveTwo1st + weightedScoreTwelveTwo2nd 
        + weightedScoreTwelveThree
        + weightedScoreTwelveFour1st + weightedScoreTwelveFour2nd 
        ;
