/*
    ...
    https://mathematicscourses.github.io/MathematicsEducation/MATH1010/GradesCalculator.html
*/
...
function gradeMLM(event) {
  ...
  var weightZeroOne = parseFloat(document.getElementById("weightZeroOne").value, 10) || 0,
    ...
    weightElevenFour1st =
      +parseFloat(document.getElementById("weightElevenFour1st").value, 10) || 0,
