/*
    ...
    https://mathematicseducation.appspot.com/MATH2132/GradesCalculator.html
*/
...
function gradeMLM(event) {
    ...
    var weightOneOne1st = parseFloat(document.getElementById("weightOneOne1st").value, 10) || 0,
        ...
        weightSevenThree2nd =+ parseFloat(document.getElementById("weightSevenThree2nd").value, 10) || 0,
        ...
        sumWeightsMLM = 
        weightOneOne1st + weightOneOne2nd 
        + weightOneTwo1st + weightOneTwo2nd 
        + weightThreeOne1st + weightThreeOne2nd 
        + weightThreeTwo1st + weightThreeTwo2nd + weightThreeTwo3rd 
        + weightThreeThree1st + weightThreeThree2nd + weightThreeThree3rd 
        + weightThreeFour1st + weightThreeFour2nd + weightThreeFour3rd 
        + weightThreeFive1st + weightThreeFive2nd 
        + weightFourOne1st + weightFourOne2nd 
        + weightFourTwo1st + weightFourTwo2nd 
        + weightFourThree1st + weightFourThree2nd 
        + weightFiveOne1st + weightFiveOne2nd + weightFiveOne3rd
        + weightFiveTwo1st + weightFiveTwo2nd + weightFiveTwo3rd
        + weightSixOne1st + weightSixOne2nd + weightSixOne3rd
        + weightSixTwo1st + weightSixTwo2nd
        + weightSixThree1st + weightSixThree2nd + weightSixThree3rd
        + weightSixFour1st + weightSixFour2nd + weightSixFour3rd
        + weightSevenOne1st + weightSevenOne2nd 
        + weightSevenTwo1st + weightSevenTwo2nd + weightSevenTwo3rd
        + weightSevenThree1st + weightSevenThree2nd 
        + weightSevenFour1st + weightSevenFour2nd + weightSevenFour3rd
        + weightSevenFive1st + weightSevenFive2nd
        ;

        document.getElementById("sumWeightsMLM").value = sumWeightsMLM;
        
        sumWeightedScoresMLM = 
        weightedScoreOneOne1st + weightedScoreOneOne2nd 
        + weightedScoreOneTwo1st + weightedScoreOneTwo2nd 
        + weightedScoreThreeOne1st + weightedScoreThreeOne2nd 
        + weightedScoreThreeTwo1st + weightedScoreThreeTwo2nd + weightedScoreThreeTwo3rd 
        + weightedScoreThreeThree1st + weightedScoreThreeThree2nd + weightedScoreThreeThree3rd 
        + weightedScoreThreeFour1st + weightedScoreThreeFour2nd + weightedScoreThreeFour3rd 
        + weightedScoreThreeFive1st + weightedScoreThreeFive2nd 
        + weightedScoreFourOne1st + weightedScoreFourOne2nd 
        + weightedScoreFourTwo1st + weightedScoreFourTwo2nd 
        + weightedScoreFourThree1st + weightedScoreFourThree2nd 
        + weightedScoreFiveOne1st + weightedScoreFiveOne2nd + weightedScoreFiveOne3rd
        + weightedScoreFiveTwo1st + weightedScoreFiveTwo2nd + weightedScoreFiveTwo3rd
        + weightedScoreSixOne1st + weightedScoreSixOne2nd + weightedScoreSixOne3rd
        + weightedScoreSixTwo1st + weightedScoreSixTwo2nd
        + weightedScoreSixThree1st + weightedScoreSixThree2nd + weightedScoreSixThree3rd
        + weightedScoreSixFour1st + weightedScoreSixFour2nd + weightedScoreSixFour3rd
        + weightedScoreSevenOne1st + weightedScoreSevenOne2nd 
        + weightedScoreSevenTwo1st + weightedScoreSevenTwo2nd + weightedScoreSevenTwo3rd
        + weightedScoreSevenThree1st + weightedScoreSevenThree2nd 
        + weightedScoreSevenFour1st + weightedScoreSevenFour2nd + weightedScoreSevenFour3rd
        + weightedScoreSevenFive1st + weightedScoreSevenFive2nd
        ;
